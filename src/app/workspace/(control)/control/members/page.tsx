          ...
          <table className="w-full text-left" role="grid">
            <thead>
              <tr style={{ borderBottom: "1px solid var(--border-color)" }}>
                ...
                <th
                  className="px-5 py-4 text-xs font-semibold uppercase tracking-wider text-right"
                  style={{ color: "var(--text-muted)" }}
                >
                  Actions
                </th>
