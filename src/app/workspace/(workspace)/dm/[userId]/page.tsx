  ...
  sam_rivera: [
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80",
      time: "10:18 AM",
      text: "Hey! 👋 Just finished reviewing the latest design specs. Overall looks great!",
      isOwn: false,
      type: "text",
    },
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80",
      time: "10:18 AM",
      text: "I left a few comments on Figma.",
      isOwn: false,
      type: "text",
    },
    {
    ...
    },
    {
      ...
      time: "10:19 AM",
      text: "Awesome! 🔥 I'll check them out right away.",
      isOwn: true,
      type: "text",
    },
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&auto=format&fit=crop&q=80",
      time: "10:20 AM",
      text: "Also, here's the prototype walkthrough.",
      isOwn: false,
      type: "text",
    },
    {
  ...
  jordan_lee: [
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&auto=format&fit=crop&q=80",
      time: "9:00 AM",
      text: "Hey, do you have the latest mockups for the settings page?",
      isOwn: false,
      type: "text",
    },
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80",
      time: "9:05 AM",
      text: 'Yes! I just uploaded them to Figma. Check the "Settings v2" page.',
      isOwn: true,
      type: "text",
    },
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&auto=format&fit=crop&q=80",
      time: "9:15 AM",
      text: "Looks good! I'll start implementing it this afternoon.",
      isOwn: false,
      type: "text",
    },
  ],
  lisa_park: [
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1634595477722-7bc68dd410fd?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      time: "3:00 PM",
      text: "The user research findings are ready. Want to schedule a review?",
      isOwn: false,
      type: "text",
    },
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80",
      time: "3:15 PM",
      text: "Got it, thank you! Let's do it tomorrow morning.",
      isOwn: true,
      type: "text",
    },
  ],
  daniel_kim: [
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80",
      time: "4:00 PM",
      text: "I pushed the latest build. Can you test it?",
      isOwn: false,
      type: "text",
    },
    {
      ...
      avatar:
        "https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&auto=format&fit=crop&q=80",
      time: "4:30 PM",
      text: "On it! I'll check it out now.",
      isOwn: true,
      type: "text",
    },
    {
    ...
    conversationMessages[id] = [
      {
        ...
        avatar: "",
        time: "9:00 AM",
        text: `Welcome to ${conv.name}! This is the start of the conversation.`,
        isOwn: false,
        type: "text",
      },
    ];
...
function AudioCallOverlay({
  ...
  return (
    <div className="absolute inset-0 z-40 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div
        className="rounded-3xl p-10 flex flex-col items-center w-[320px] shadow-2xl"
        style={{
          ...
          <button type="button"
            ...
            className={`w-12 h-12 rounded-full flex items-center justify-center transition-colors ${
              isMuted
                ...
                : "bg-theme-card text-theme-secondary hover-theme-card"
            }`}
          >
...
export default function MessagingPage() {
  // Seed the active conversation from the dynamic [userId] route segment so
  // /workspace/dm/jordan_lee opens Jordan's thread, falling back to the
  // default when the id is unknown (e.g. the placeholder /dm/user_1 link).
  const params = useParams<{ userId: string }>();
  const routeUserId =
    typeof params?.userId === "string" ? params.userId : undefined;
  const [activeConvId, setActiveConvId] = useState(
    routeUserId && conversations.some((c) => c.id === routeUserId)
      ? routeUserId
      : "sam_rivera"
  );
  ...
  const [messagesByConv, setMessagesByConv] =
    useState<Record<string, ChatMessage[]>>(conversationMessages);
  ...
  // Local optimistic send — replace with a store/API call when the messaging
  // backend is wired up.
  ...
  return (
    <div
      className="flex-1 flex overflow-hidden font-sans relative"
      style={{
            ...
            <button type="button"
              ...
              className={`w-full flex items-center gap-3 px-3 py-3 rounded-xl transition-all ${
                activeConvId === conv.id
                  ? "bg-theme-brand-subtle border border-purple-600/20"
            ...
            >
              <div className="relative shrink-0">
                {conv.avatar ? (
                  ...
                  <div
                    className={`w-10 h-10 ${conv.bgColor} rounded-full flex items-center justify-center font-bold text-[11px] text-white`}
                  >
                    {conv.initials}
                  </div>
                )}
                {!conv.isGroup && conv.online && (
                  <div
                    className="absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full bg-theme-success border-2"
              ...
              <div className="flex-1 min-w-0 text-left">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] text-theme-muted shrink-0 ml-2">
                    {conv.time}
                  </span>
                </div>
                <div className="flex items-center justify-between mt-0.5">
                  ...
                  {conv.unread > 0 && (
                    <span className="w-5 h-5 rounded-full bg-theme-brand text-[10px] font-bold text-white flex items-center justify-center shrink-0 ml-2">
                      {conv.unread}
                    </span>
                  )}
                </div>
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              {activeConv.avatar ? (
                ...
                <div
                  className={`w-10 h-10 ${activeConv.bgColor || "bg-theme-card"} rounded-full flex items-center justify-center font-bold text-[11px] text-white`}
                >
                  {activeConv.initials}
                </div>
              )}
              {activeConv.online && (
                <div className="absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full bg-theme-success border-2 border-theme" />
              )}
            </div>
            <div>
              ...
              return (
                <div key={idx} className="flex gap-1.5 ml-11">
                  {msg.reactions.map((r, ri) => (
                    <span
                      key={ri}
                      className="w-7 h-7 rounded-full flex items-center justify-center text-sm cursor-pointer transition-colors"
                      style={{
                        backgroundColor: "var(--bg-card)",
                        border: "1px solid var(--border-color)",
                      }}
            ...
            return (
              ...
              >
                ...
                <div className={`${msg.isOwn ? "text-right" : ""} max-w-lg`}>
                    ...
                    <>
                      <div
                        className={`inline-block px-4 py-2.5 rounded-2xl text-sm leading-relaxed ${
                          msg.isOwn
                            ? "bg-theme-brand text-white rounded-br-md"
                    ...
                    <div className="flex flex-col">
                      ...
                      >
                        ...
                        <div className="flex items-center gap-[2px] h-6">
                          {[
                            40, 65, 30, 80, 50, 70, 35, 90, 45, 75, 60, 85, 25,
                            55, 70, 40, 65, 80, 30, 50, 75, 45, 60, 85, 35, 55,
                            70, 40, 65, 80,
                          ].map((h, i) => (
                            <div
                              key={i}
                              className="w-[3px] rounded-full bg-theme-secondary"
                              style={{ height: `${h}%` }}
                            />
                          ))}
                        </div>
                        ...
                        <span className="text-xs font-semibold text-theme-muted shrink-0">
                          1x
                        </span>
                      </div>
                    </div>
                  ...
                  {msg.type === "file" && (
                    <div
                      className="rounded-2xl rounded-bl-md overflow-hidden max-w-sm"
                      style={{
                        backgroundColor: "var(--bg-card)",
                        border: "1px solid var(--border-color)",
                      }}
