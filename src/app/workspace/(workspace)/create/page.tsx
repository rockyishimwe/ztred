      ...
      <div className="w-full max-w-xl">
        ...
        <div className="flex items-center justify-center gap-0 mb-10">
          ...
          {step > 1 && (
            <button
              onClick={handleBack}
              className="w-8 h-8 rounded-lg flex items-center justify-center text-zinc-400 hover:text-white hover:bg-zinc-800 transition-colors mr-3"
            >
          ...
          {step === 1 && (
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                <button className="w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-lg shrink-0 transition-colors hover:opacity-90"
                ...
                <div className="flex-1">
                  ...
                  <input
                    ...
                    className="w-full bgCard borderCard rounded-xl px-4 py-3 text-white placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 text-sm transition-all"
                  />
                </div>
              </div>
                    ...
                    <button
                      ...
                      className={`py-3 px-4 rounded-xl border text-sm font-medium transition-all ${
                        selectedTeamType === type
                          ...
                          : 'bg-[#0e121d] border-zinc-800 text-zinc-400 hover:border-zinc-700 hover:text-zinc-300'
                      }`}
                    >
                      {type}
                    </button>
          ...
          {step === 2 && (
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm mt-1">
                  Add teammates to <span className="text-white font-semibold">{workspaceName || 'dddd'}</span>. They&apos;ll get an email invite.
                </p>
              </div>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="flex-1 bgCard borderCard rounded-xl px-4 py-3 text-white placeholder-zinc-600 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 text-sm transition-all"
                />
                <button
                  onClick={addInvitee}
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  disabled={isCreating}
                  className="flex-1 py-3 rounded-xl border border-zinc-700 text-zinc-300 font-semibold text-sm hover:bg-zinc-800 transition-all disabled:opacity-50"
                >
