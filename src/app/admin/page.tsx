...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-[#090A0F] text-white flex flex-col font-sans">
      {/* Admin Top Header */}
      <header className="h-16 border-b border-zinc-800 px-6 flex items-center justify-between bg-[#0E0F17]">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-base text-white">ZTRED Super Admin Dashboard</span>
          </div>
        </div>
      ...
      <div className="flex-1 max-w-7xl w-full mx-auto p-6 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="p-5 rounded-2xl bg-[#10111A] border border-zinc-800">
          ...
          <div className="p-5 rounded-2xl bg-[#10111A] border border-zinc-800">
            ...
            <div className="text-2xl font-bold text-white">62.1%</div>
            <span className="text-xs text-zinc-400 mt-1 block">7.4 / 12.0 GB allocation</span>
          </div>
          ...
          <div className="p-5 rounded-2xl bg-[#10111A] border border-zinc-800">
            ...
            <span className="text-xs text-zinc-400 mt-1 block">Last incident: 42d ago</span>
          </div>
        ...
        {/* Organizations Table */}
        <div className="p-6 rounded-2xl bg-[#10111A] border border-zinc-800 space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-base font-bold text-white">Organization Management</h3>
            <div className="relative">
              <input
                type="text"
                placeholder="Search organizations..."
                className="pl-8 pr-3 py-1.5 bg-zinc-900 border border-zinc-800 rounded-md text-xs text-white focus:outline-none focus:border-purple-500"
              />
              ...
              <tbody className="divide-y divide-zinc-800/60">
                {orgs.map((org) => (
                  <tr key={org.id} className="hover:bg-zinc-900/50 transition-colors">
                    ...
                    <td className="py-3 font-mono text-zinc-300">{org.members}</td>
                    <td className="py-3 text-purple-400 font-semibold">{org.plan}</td>
                    <td className="py-3 font-mono text-zinc-400">{org.storage}</td>
                    <td className="py-3">
